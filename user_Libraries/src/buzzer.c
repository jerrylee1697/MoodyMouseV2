...
void levelComplete(void) {
	shortBeep(5000, NOTE_G3);
	delay_ms(100);
	shortBeep(5000, NOTE_C4);
	delay_ms(100);
	shortBeep(5000, NOTE_E4);
	delay_ms(100);
	shortBeep(5000, NOTE_G4);
	delay_ms(100);
	shortBeep(5000, NOTE_C5);
	delay_ms(100);
	shortBeep(5000, NOTE_E5);
	delay_ms(100);
	shortBeep(15000, NOTE_G5);
	delay_ms(300);
	shortBeep(15000, NOTE_E5);
	delay_ms(300);
	
	shortBeep(5000, NOTE_GS3);
	delay_ms(100);
	shortBeep(5000, NOTE_C4);
	delay_ms(100);
	shortBeep(5000, NOTE_DS4);
	delay_ms(100);
	shortBeep(5000, NOTE_GS4);
	delay_ms(100);
	shortBeep(5000, NOTE_C5);
	delay_ms(100);
	shortBeep(5000, NOTE_DS5);
	delay_ms(100);
	shortBeep(15000, NOTE_GS5);
	delay_ms(300);
	shortBeep(15000, NOTE_DS5);
	delay_ms(300);
	
	shortBeep(5000, NOTE_GS3);
	delay_ms(100);
	shortBeep(5000, NOTE_D4);
	delay_ms(100);
	shortBeep(5000, NOTE_F4);
	delay_ms(100);
	shortBeep(5000, NOTE_AS5);
	delay_ms(100);
	shortBeep(5000, NOTE_D6);
	delay_ms(100);
	shortBeep(5000, NOTE_F6);
	delay_ms(100);
	shortBeep(15000, NOTE_AS6);
	delay_ms(300);
	shortBeep(50, NOTE_AS6);
	delay_ms(100);
	shortBeep(50, NOTE_AS6);
	delay_ms(100);
	shortBeep(50, NOTE_AS6);
	delay_ms(100);
	shortBeep(1200, NOTE_C7);
	delay_ms(600);
}


void R2(void) {
	shortBeep((rand()% 200)+40, 3520);
	delay_ms((rand()% 200)+40);
	shortBeep((rand()% 200)+40, 3135);
	delay_ms((rand()% 200)+40);
	shortBeep((rand()% 200)+40, 2637);
	delay_ms((rand()% 200)+40);
	shortBeep((rand()% 200)+40, 2093);
	delay_ms((rand()% 200)+40);
	shortBeep((rand()% 200)+40, 2349);
	delay_ms((rand()% 200)+40);
	shortBeep((rand()% 200)+40, 3951);
	delay_ms((rand()% 200)+40);
	shortBeep((rand()% 200)+40, 2793);
	delay_ms((rand()% 200)+40);
	shortBeep((rand()% 200)+40, 4186);
	delay_ms((rand()% 200)+40);
	shortBeep((rand()% 200)+40, 3520);
	delay_ms((rand()% 200)+40);
	//shortBeep((rand()% 200)+40, );
	//delay_ms((rand()% 200)+40);
}
